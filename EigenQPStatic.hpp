...
#define EMAT(n, m) Matrix<double, n, m>
#define EVEC(n) Vector<double, n, 1>
...
// The Solving function, implementing the Goldfarb-Idnani method
	...
	template<int n, p, m>
double solve_quadprog(EMAT(n, n)& G, EVEC(n)& g0, 
                      const EMAT(n, p)& CE, const EVEC(p)& ce0,  
                      const EMAT(n, m)& CI, const EVEC(m)& ci0, 
                      EVEC(n)& x)
{
